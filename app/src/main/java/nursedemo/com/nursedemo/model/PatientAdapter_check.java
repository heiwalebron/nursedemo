 ...
 */
public class PatientAdapter_check extends BaseAdapter {
    Context context;
    ArrayList<Patient> patientArrayList;

    public PatientAdapter_check(Context context, ArrayList<Patient> patientArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            convertView= LayoutInflater.from(context).inflate(R.layout.patient_item_check, parent, false);
